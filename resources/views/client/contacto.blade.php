<x-app-layout>
    ...
    <section class="contact position-relative d-grid justify-content-center align-content-center py-2 py-lg-5">
        ...
        <div class="contact__container container py-5  py-lg-5 m-0  justify-content-center align-content-center gap-5 ">
          ...
          <form action="{{ route('contacts.store') }}" method="POST" class="contact__card d-flex flex-column gap-5  rounded-3 shadow-lg bg-white w-100">
        ...
        @endif
            <div class="">
              ...
              <input type="text" name="nombre" value="{{old('nombre')}}" class="form-control border-0 border-bottom rounded-0" id="exampleFormControlInput1"
                placeholder="Juan Martin">
            </div>
  
            <div class="">
              <label for="exampleFormControlInput1" class="form-label">Correo*</label>
              <input type="email" name="correo" value="{{old('correo')}}" class="form-control border-0 border-bottom rounded-0" id="exampleFormControlInput1"
                placeholder="name@example.com">
            </div>
  
            <div class="">
              <label for="exampleFormControlInput1" class="form-label">Telefono*</label>
              <input type="text" name="telefono" value="{{old('telefono')}}" class="form-control border-0 border-bottom rounded-0" id="exampleFormControlInput1"
                placeholder="+885 1254 5211 552">
            </div>
  
            <div class="">
              <label for="exampleFormControlTextarea1" class="form-label">Mensaje*</label>
              <textarea name="mensaje" value="{{old('mensaje')}}" class="form-control border-0 border-bottom rounded-0" id="exampleFormControlTextarea1" rows="1"
