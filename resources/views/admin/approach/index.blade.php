<x-admin-layout>
    ...
    <div class=" d-flex justify-content-between pb-2">
        <div class="">
            <h2 class="dashboard__title">Enfoques</h2>
    ...
    <div class="p-2 p-lg-4 shadow-sm mb-5">
        @can('admin.enfoques.create')
            <div class="d-flex justify-content-start my-3">
                <a href="{{ route('admin.enfoques.create') }}" class="btn btn-success">Nuevo</a>
            </div>
        @endcan
        <table id="example"class="table table-striped dt-responsive nowrap" style="width:100%">
            ...
            <tbody>
                ...
                @foreach ($approachs as $approach)
                    <tr class="">
                        <td class="text-center">{{ $approach->id }}</td>
                        <td class="text-center">{{ $approach->name }}</td>

                        @can('admin.enfoques.edit')
                            <td class="text-center">
                                <a href="{{ route('admin.enfoques.edit', $approach) }}"
