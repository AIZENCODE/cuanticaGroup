<x-admin-layout>
    ...
    <div class=" d-flex justify-content-between pb-2">
        <div class="">
            <h2 class="dashboard__title">Clientes</h2>
    ...
    <div class="p-2 p-lg-4 shadow-sm mb-5">
        ...
        @can('admin.clientes.create')
            <div class="d-flex justify-content-start my-3">
                <a href="{{ route('admin.clientes.create') }}" class="btn btn-success">Nuevo</a>
            </div>
        @endcan
                    ...
                    <tr class="">
                        ...
                        @can('admin.clientes.edit')
                            <td class="text-center">
                                <a href="{{ route('admin.clientes.edit', $client) }}" class="btn btn-primary text-white"><i
